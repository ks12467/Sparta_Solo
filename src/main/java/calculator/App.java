...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Calculator calc = new Calculator(); // Calculator 생성자
        ArithmeticCalculator arithmeticCalculator = new ArithmeticCalculator(); // Arithmetic 생성자
        CircleCalculator circleCalculator = new CircleCalculator(); // CircleCalculator 생성자
        ...
        while (true) {
            try {
                ...
                if (str.equals("history")) {
                    ...
                    double radius = sc.nextDouble(); //원의 반지름을 입력받음
            ...
            //결과 값 삭제 메서드
            if (str.equals("y")) {
                System.out.println("계산을 다시 시작합니다."); //다시 반복
            } else if (str.equals("remove")) {
                List<Double> results = calc.getResults(); //결과 리스트를 가져옴
                calc.removeResult(); //결과 삭제 메서드 호출
